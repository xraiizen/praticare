...
class CardPratitienRdvPrevus extends StatefulWidget {
  ...
  @override
  _CardPratitienRdvPrevusState createState() => _CardPratitienRdvPrevusState();
}

class _CardPratitienRdvPrevusState extends State<CardPratitienRdvPrevus> {
  late Widget card;
  @override
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            BtnValidator(text: ("Afficher le lieu"), activePrimaryTheme: false)
          ],
        ),
      ),
    );
